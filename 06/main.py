...
while True:
    ...
    elif command_parser.is_desk_status_command(command):
        timestamp, floor_id, desk_id = command_parser.desk_status_command_parser(command)
        response = building.get_desk_status_by_id(timestamp, floor_id, desk_id)
